...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull EditText emailLogin,
      @NonNull Button loginBtn, @NonNull EditText passwordLogin, @NonNull ProgressBar progressbar,
      @NonNull ImageView regImg, @NonNull TextView signUp, @NonNull TextView textView) {
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, emailLogin, loginBtn,
          passwordLogin, progressbar, regImg, signUp, textView);
    }
